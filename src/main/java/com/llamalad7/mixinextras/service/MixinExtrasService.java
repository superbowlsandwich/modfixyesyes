...
/* JADX INFO: loaded from: arcane_convergence-1.0.0bugfix-all.jar:META-INF/jarjar/mixinextras-forge-0.4.1.jar:META-INF/jars/MixinExtras-0.4.1.jar:com/llamalad7/mixinextras/service/MixinExtrasService.class */
public interface MixinExtrasService {
    ...
    static MixinExtrasService getFrom(Object serviceImpl) {
        return (MixinExtrasService) ProxyUtils.getProxy(serviceImpl, MixinExtrasService.class);
    }
