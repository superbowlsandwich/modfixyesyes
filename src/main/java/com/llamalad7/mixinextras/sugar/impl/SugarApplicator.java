...
/* JADX INFO: loaded from: arcane_convergence-1.0.0bugfix-all.jar:META-INF/jarjar/mixinextras-forge-0.4.1.jar:META-INF/jars/MixinExtras-0.4.1.jar:com/llamalad7/mixinextras/sugar/impl/SugarApplicator.class */
abstract class SugarApplicator {
    ...
    abstract void validate(Target target, InjectionNodes.InjectionNode injectionNode);

    abstract void prepare(Target target, InjectionNodes.InjectionNode injectionNode);

    abstract void inject(Target target, InjectionNodes.InjectionNode injectionNode, StackExtension stackExtension);

    static {
        List<Pair<Class<? extends Annotation>, Class<? extends SugarApplicator>>> sugars = Arrays.asList(Pair.of(Cancellable.class, CancellableSugarApplicator.class), Pair.of(Local.class, LocalSugarApplicator.class), Pair.of(Share.class, ShareSugarApplicator.class));
