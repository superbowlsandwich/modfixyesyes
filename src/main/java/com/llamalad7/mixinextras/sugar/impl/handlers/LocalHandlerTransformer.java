...
/* JADX INFO: loaded from: arcane_convergence-1.0.0bugfix-all.jar:META-INF/jarjar/mixinextras-forge-0.4.1.jar:META-INF/jars/MixinExtras-0.4.1.jar:com/llamalad7/mixinextras/sugar/impl/handlers/LocalHandlerTransformer.class */
class LocalHandlerTransformer extends HandlerTransformer {
    ...
    public void transform(HandlerInfo info) {
        ...
        info.wrapParameter(this.parameter, wrapperType, ASMUtils.isPrimitive(this.parameter.type) ? null : this.parameter.type, (insns, load) -> {
